...
int main(int argc, char *argv[])
{
	...
	start_time = get_secv();
	//power_itimes = power_method<mpreal>(min_eig, x, matrix, dimension, rel_tol, abs_tol, dimension * 5);
	power_itimes = inverse_power_method_cg<mpreal>(min_eig, x, matrix, dimension, rel_tol, abs_tol, dimension * 5);
